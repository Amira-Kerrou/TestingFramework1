...
public class CatalogLocators {
    ...
    @FindBy(xpath = "//input[@class='form-control-search ng-pristine ng-valid ng-touched' and @type='text']")
    ...
    @FindBy(xpath = "//input[@class='form-control ng-invalid has-error ng-touched ng-dirty' and @formcontrolname='Name' and @type='text']")
    ...
    @FindBy(xpath = "(//div[@class='col-lg-2 col-md-4 col-sm-12 align-items-stretch']//a[b[text()='Request']])[1]")
