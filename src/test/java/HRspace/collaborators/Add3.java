...
public class Add3 extends CollabTasks {
    ...
    public void collabPage(List<CollaboratorModel> itemList) {
        ...
        tasks.addNewCollaborator(itemList.get(2));
        tasks.searchCollaborator(itemList.get(2).getFirstName() + itemList.get(2).getLastName());
    }
    @AfterMethod
