...
public class Add4 extends CollabTasks {
    ...
    public void collabPage(List<CollaboratorModel> itemList) {
        ...
        tasks.addNewCollaborator(itemList.get(3));
        tasks.searchCollaborator(itemList.get(3).getFirstName() + itemList.get(3).getLastName());
    }
    @AfterMethod
